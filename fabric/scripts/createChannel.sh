...
joinChannel() {
  ...
  setGlobals $ORG
	...
	cat log.txt
	verifyResult $res "After $MAX_RETRY attempts, peer$2.org${ORG} has failed to join channel '$CHANNEL_NAME' "
}
...
# infoln "Joining peer0 of org1 peer to the channel..."
# joinChannel 1 0
# infoln "Joining peer0 of org2 peer to the channel..."
# joinChannel 2 0

# infoln "Joining peer1 of org1 peer to the channel..."
# joinChannel 11 1
# infoln "Joining peer1 of org2 peer to the channel..."
# joinChannel 21 1
